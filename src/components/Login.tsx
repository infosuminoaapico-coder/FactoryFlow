    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-500">
        <div className="p-8 pb-0 text-center">
          ...
          <p className="text-gray-500 text-sm">ระบบจัดการสต๊อก WoodCraft IMS</p>
        </div>
        ...
        <div className="p-8 pt-0 border-t border-gray-100 text-center">
          <p className="text-[10px] text-gray-400 mb-2 uppercase font-bold italic tracking-tighter">
            🪵 WoodCraft Factory IMS &copy; 2026
          </p>
        </div>
      </div>
    </div>
